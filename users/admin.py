...
class UserCreationForm(forms.ModelForm):
    ...
    class Meta:
        model = Stars
        fields = ('email', 'username', 'password', 'first_name', 'last_name', 'phone', 'avatar', 'is_star',
...
class UserChangeForm(forms.ModelForm):
    ...
    class Meta:
        model = Stars
        fields = ('email', 'username', 'password', 'first_name', 'last_name', 'phone', 'avatar', 'is_star',
                  'cat_name_id', 'price', 'price_another', 'rating', 'profession' ,'video_hi', 'description', 'tags',)
...
class StarsAdmin(BaseUserAdmin):
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('email', 'password1', 'password2', 'phone', 'username', 'price', 'price_another',
...
class CongratulationPageVideosAdmin(admin.StackedInline):
    model = CongratulationPageVideos


@admin.register(CongratulationPage)
class CongratulationPageAdmin(admin.ModelAdmin):
    list_display = ('content', )
    inlines = [ CongratulationPageVideosAdmin, ]
