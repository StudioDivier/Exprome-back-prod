...
from .models import Customers, Stars, Users, Ratings, Orders, Categories, Avatars, Videos, \
    Congratulations, Likes, MessageChats, RequestsForm, Favorites
from .models import CongratulationPage, CongratulationPageVideos


class CongratulationPageSerializer(serializers.ModelSerializer):
    class Meta:
        model = CongratulationPage
        fields = ('__all__', )


class CongratulationPageVideosSerializer(serializers.ModelSerializer):
    class Meta:
        model = CongratulationPageVideos
        fields = ( '__all__', )
...
class StarSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Stars
        fields = ('id', 'username', 'first_name', 'last_name', 'password', 'phone', 'description', 'top', 'sorted', 'email', 'price',
                  'price_another', 'cat_name_id', 'profession', 'rating', 'is_star', 'days')
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ('id', 'customer_id', 'star_id', 'payment_id', 'order_price',
                  'by_date', 'by_time', 'for_whom', 'comment', 'status_order', 'type')
...
class RegistrationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Customers
        fields = ('username', 'phone', 'email', 'password', 'is_star', 'token', 'register')
...
class RegistrationStarSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Stars
        fields = ('username', 'phone', 'email', 'password', 'price','rating', 'price_another',
...
class LoginSerializer(serializers.Serializer):
    ...
    def validate(self, data):
        ...
        if '@' in login:
            kwargs = {'email': login, 'password': password}
        else:
            kwargs = {'username': login, 'password': password}
