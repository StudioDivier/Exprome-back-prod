...
from .views import PreGoogleView, MidGoogleView, FavoriteView, RegistarationConfirm, CongratulationPageView
...
urlpatterns = [
    ...
    path('registration-confirm/', RegistarationConfirm.as_view(), name=None),

    path('example/', CongratulationPageView.as_view(), name=None),
    ...
    path('star/favorite/',FavoriteView.as_view(), name=None),
    ...
    path('support/', SupportView.as_view(), name=None)
]
